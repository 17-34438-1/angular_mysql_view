...
@Component({
  selector: 'app-mis-assignment-gcb-report',
  templateUrl: './mis-assignment-gcb-report.component.html',
  styleUrls: ['./mis-assignment-gcb-report.component.css']
})
export class MisAssignmentGcbReportComponent implements OnInit {
  date:any;
  terminal:any;
  block:any;
  assignmentType:any;
